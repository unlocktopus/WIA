/*
 * windows/x64/messagebox - 350 bytes
 * https://metasploit.com/
 * VERBOSE=false, PrependMigrate=false, EXITFUNC=thread, 
 * TITLE=Hola HackGDL!, TEXT=Hola HackGDL!, ICON=INFORMATION
 */
unsigned char buf[] = 
...
//Genera messagebox con el texto "Hola HackGDL!", para usarse como test con los encoders
